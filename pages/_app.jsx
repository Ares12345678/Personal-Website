...
function MyApp({ Component, pageProps }) {
  ...
  return (<>
    <Head>
        ...
        <link rel="shortcut icon" href="https://cdn.discordapp.com/attachments/1017089854053556248/1018977171349454968/181ce6c61d1564c57274634650f3ac2a.jpg" type="image/x-icon" ></link>
          ...
          <div className="md:flex w-full items-center justify-between">
            ...
            <div className="mt-2 md:mt-0 flex items-center">
              <a href="" target="_blank" rel="noreferrer" className="w-full md:w-auto bg-neutral-700/5 hover:bg-neutral-700/20 px-4 py-2 rounded-md transition-all duration-200">
                <i className="fab fa-discord mr-2" />Yakında
              </a>
            </div>
